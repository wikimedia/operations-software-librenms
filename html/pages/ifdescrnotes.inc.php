...
$notes_param[] = '%'.$vars['notes'].'%';
$ports       = dbFetchRows("SELECT * FROM `ports` as I, `devices` AS D WHERE port_descr_notes LIKE ? AND I.device_id = D.device_id ORDER BY I.ifAlias", $notes_param);
...
echo "<tr class='iftype'>
    <td colspan='5'><span class=list-large>Total Graph for ports with notes: ".$vars['notes'].'</span><br />';
